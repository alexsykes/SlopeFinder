<x-layout>
    ...
    <div class="text-black leading-6">
        ...
        <div class="my-4 text-sm font-semibold">Further clarification of the privacy and security arrangements for users' personal data can be supplied on request from the site developer using the <a href="contact">Contact page</a>.</div>
    </div>
</x-layout>