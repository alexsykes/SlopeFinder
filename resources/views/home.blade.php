	...
	<script>
		...
		async function initMap() {
			...
			if (navigator.geolocation) {
				...
				httpGetAsync("https://api.openweathermap.org/data/3.0/onecall?lat=53.8&lon=-2&units=metric&exclude=minutely&appid=6aff05a2599912b387c2b5390360cc84",myCallback)
			}
		}
